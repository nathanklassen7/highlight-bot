...
tmux new-session -d "jack_capture -O ${OSC_PORT} --port system:capture_1 --timemachine --timemachine-prebuffer ${PREBUFFER} -Hc ${SCRIPT_DIR}/jack_finish.sh ${SCRIPT_DIR}/buffer.wav"
