...
tmux new-session -d "/bin/jack_capture -O ${OSC_PORT} --port system:capture_1 --port system:capture_2 --timemachine --timemachine-prebuffer ${PREBUFFER} -Hc ${SCRIPT_DIR}/jack_finish.sh ${SCRIPT_DIR}/buffer.wav"
