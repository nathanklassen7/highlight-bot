...
Follow the printed URL to authenticate. The Pi will reconnect automatically on every boot. The web UI is then reachable at `http://<pi-tailscale-ip>:8080`.

### 8. (Optional) Disable the desktop (Not required on Pi OS Lite)
